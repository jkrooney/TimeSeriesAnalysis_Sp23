...
```{r}
<<<<<<< HEAD
class_ts_inflow_data<-ts(inflow_data[,2:(2+nhydro-1)], frequency=12,start=c(1931,1))
head(class_ts_inflow_data,20)
=======
...
for(i in 1:nhydro){
  par(mfrow=c(1,2))
Acf(class_ts_inflow_data[,i], lag.max = 40, main=paste0("HP",i),ylim=c(-1,1))
Pacf(class_ts_inflow_data[,1], lag.max = 40, main=paste0("HP",i),ylim=c(-1,1))
}
=======
