...
>>>>>>> d453bcaa1e7ba0def7109f5e9d214404293702b1
...
head(df_wind_data,10)
tail(df_wind_data,10)
# Discuss the results

#Ex5 multiplicative
decompose_multi_wind_data=decompose(clean_wind_data, type="multiplicative")
plot(decompose_multi_wind_data)

#Ex6 stl function (can only do additive)
stl_decompose_wind_data<- stl(clean_wind_data, s.window="periodic")
plot(stl_decompose_wind_data)
=======
