...
> Answer: I have pulled data sets from Github before while taking ENV 710, but had never used Github or Git like we will be in this class with forking and cloning a repository and pushing and pulling files. My R experience is limited to 710, as is my very limited exposure to time series analysis.
...
> Answer: https://github.com/ENV790/TimeSeriesAnalysis_Sp23.git
